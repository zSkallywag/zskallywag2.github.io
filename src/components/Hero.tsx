...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-x-clip overflow-y-visible bg-background px-4 sm:px-6 py-20 pt-32">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1
                className={`text-5xl md:text-7xl font-black leading-tight transition-all duration-800 ${
            ...
            <p
              className={`text-xl md:text-2xl text-secondary leading-relaxed transition-all duration-800 ${
