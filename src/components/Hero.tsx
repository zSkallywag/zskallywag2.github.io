...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-x-clip overflow-y-visible bg-background px-4 sm:px-6 pt-24 pb-16 md:pt-32 md:pb-24">
          ...
          <div className="relative flex justify-center md:justify-end">
            ...
            >
              <img
                ...
                className="max-w-[85%] md:max-w-full h-auto animate-float object-contain"
